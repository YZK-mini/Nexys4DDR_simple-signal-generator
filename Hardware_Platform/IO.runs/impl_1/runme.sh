...
EAStep vivado -log design_CPU_System_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_CPU_System_wrapper.tcl -notrace
