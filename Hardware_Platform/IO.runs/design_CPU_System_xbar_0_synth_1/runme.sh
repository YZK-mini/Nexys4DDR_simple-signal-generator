...
HD_PWD='D:/3/IO/IO.runs/design_CPU_System_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_CPU_System_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_CPU_System_xbar_0.tcl
