...
EAStep vivado -log design_CPU_System_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_CPU_System_wrapper.tcl
