...
#set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports {  TX0}]; #IO_L22N_T3_A16_15 Sch=ja[9]
...
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { RX0 }]; #IO_0_15 Sch=jb[9]
